...
from characters import spawnBarbarian, move_barbarians,move_healers,spawnHealers, spawnArcher, move_archers, spawnDragon, move_dragons, spawnBalloon, move_balloons, clearTroops
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnArcher(V.spawn_points[0],0)
    elif ch == 'o':
        spawnArcher(V.spawn_points[1],0)
    elif ch == 'p':
        spawnArcher(V.spawn_points[2],0)
    elif ch == 'e':
        MY_GLOBAL_VAR=1
